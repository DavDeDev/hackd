...
class Url(SupportsAllComparisons):
    ...
    def scheme(self) -> str:
        ...
        e.g. `https` in `REMOVED_SECRET:port/path?query#fragment`
        """
    @property
    def username(self) -> str | None:
        ...
        e.g. `user` in `REMOVED_SECRET:port/path?query#fragment`
        """
    @property
    def password(self) -> str | None:
        ...
        e.g. `pass` in `REMOVED_SECRET:port/path?query#fragment`
        """
    @property
    ...
    def unicode_host(self) -> str | None:
        ...
        e.g. `host` in `REMOVED_SECRET:port/path?query#fragment`
    ...
    def port(self) -> int | None:
        ...
        e.g. `port` in `REMOVED_SECRET:port/path?query#fragment`
        """
    @property
    def path(self) -> str | None:
        ...
        e.g. `/path` in `REMOVED_SECRET:port/path?query#fragment`
        """
    @property
    def query(self) -> str | None:
        ...
        e.g. `query` in `REMOVED_SECRET:port/path?query#fragment`
        """
    def query_params(self) -> list[tuple[str, str]]:
        """
        The query part of the URL as a list of key-value pairs.

        e.g. `[('foo', 'bar')]` in `REMOVED_SECRET:port/path?foo=bar#fragment`
        """
    @property
    def fragment(self) -> str | None:
        ...
        e.g. `fragment` in `REMOVED_SECRET:port/path?query#fragment`
        """
