...
class HfApi:
    ...
    def list_repo_tree(
        ...
        *,
        ...
        Examples:
            ...
            >>> list(repo_tree)
            [
                RepoFile(path='.gitattributes', size=391, blob_id='***REMOVED***', lfs=None, last_commit=None, security=None),
                RepoFile(path='README.md', size=391, blob_id='REMOVED_SECRET', lfs=None, last_commit=None, security=None),
                RepoFile(path='config.json', size=554, blob_id='***REMOVED***', lfs=None, last_commit=None, security=None),
                RepoFile(
                ...
                RepoFile(path='merges.txt', size=456318, blob_id='***REMOVED***', lfs=None, last_commit=None, security=None),
                RepoFile(
                ...
                RepoFile(path='vocab.json', size=898669, blob_id='***REMOVED***', lfs=None, last_commit=None, security=None)]
            ]
            ```
    ...
    def get_paths_info(
        ...
        *,
        ...
        >>> paths_info
        [
            RepoFile(path='README.md', size=2379, blob_id='***REMOVED***', lfs=None, last_commit=None, security=None),
            RepoFolder(path='en', tree_id='***REMOVED***', last_commit=None)
        ]
        ```
        """
        repo_type = repo_type or REPO_TYPE_MODEL
